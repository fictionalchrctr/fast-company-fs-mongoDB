...
const EditUserPage = () => {
  ...
  }, [data]) // каждый раз, когда изменяется data
    ...
    <div className='container mt-5'>
      ...
      <div className='row'>
        <div className='col-md-6 offset-md-3 shadow p-4'>
          {!isLoading && Object.keys(professions).length > 0 ? ( // в случае, когда нет загрзки (isLoading) и загружены профессии, то рендерим форму первый раз
